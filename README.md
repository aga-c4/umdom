...
---
**Для запуска:**
1. Копируем или делаем по аналогии app/configs/demo в app/configs/user. Конфиги перекрывают default конфиг
2. Копируем или делаем по аналогии app/lang_sample в app/lang
3. В папках controllers, models можно создать папку user, в которой разместить свои кастомные контроллеры и модели
4. Создаем виртуальное окружение и загружаем пакеты в него
```
python3 -m venv venv
